...
cd "$NGINX_DIR" 
./configure --with-compat --add-dynamic-module="../${MODULE_DIR}/" --with-debug --with-cc-opt="-I$HIREDIS_DIR" --with-ld-opt="-L$HIREDIS_DIR -lhiredis"


make modules || (echo "make failed" && exit)
